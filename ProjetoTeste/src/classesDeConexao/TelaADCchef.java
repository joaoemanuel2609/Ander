...
public class TelaADCchef extends JFrame {
	...
	public TelaADCchef() {
		...
		NomeCliente.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		horasComeça.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaADCchef tADC = new TelaADCchef();
		...
		horasFinaliza.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		servicos.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		FormaPagamento.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		valorCobrado.setFont(new Font("Tahoma", Font.ITALIC, 15));
		...
		btnNewButton.setBounds(538, 572, 245, 35);
		...
		lblFormaDePagamento.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblFormaDePagamento.setBounds(385, 438, 182, 35);
		contentPane.add(lblFormaDePagamento);
		lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(TelaADCchef.class.getResource("/classesDeConexao/babidi-removebg-preview (1).png")));
		...
		lblHorarioFimDo.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblHorarioFimDo.setBounds(385, 377, 182, 35);
		...
		lblNomeDoBarbeiro.setBounds(397, 89, 182, 35);
		contentPane.add(lblNomeDoBarbeiro);
		
		lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(TelaADCchef.class.getResource("/classesDeConexao/TelaADC.png")));
